      ...
      <div className="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-evenly gap-6 md:flex-row">
          <div className="flex flex-col max-w-xs">
            <Logo className={"mx-auto md:m-0"} />
            <div className="flex flex-col space-y-2 my-2">
              <p className="flex items-center text-center gap-6 text-slate-600 md:text-wrap  md:text-start">
                A firm that is concentrated on equipping African youths with the
                knowledge and skills needed to excel in the tech space.
              </p>

              {/* <!-- Socials --> */}
              <div className="flex items-center gap-3 w-45 mx-auto md:text-start">
                <a
                  href="#"
                  aria-label="Twitter"
              ...
              <p className="flex items-center text-center mx-auto gap-6 text-slate-600 text-wrap md:text-start md:m-0">
          ...
          {/* Contact Company */}
          <nav className="flex flex-col text-center gap-1 text-sm text-slate-600 md:text-start">
